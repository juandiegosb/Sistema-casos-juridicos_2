...
export default function Home() {
  const stats = [
    { icon: FileText, label: "Casos Activos", value: "99", change: "+12%", color: "text-blue-600" },
    { icon: Users, label: "Usuarios", value: "99", change: "+5%", color: "text-purple-600" },
    { icon: Activity, label: "Consultas Hoy", value: "99", change: "+18%", color: "text-green-600" },
    { icon: TrendingUp, label: "Casos Resueltos", value: "99", change: "+8%", color: "text-orange-600" },
  ]
  ...
  return (
    <div className="p-6 lg:p-10 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Panel de control del consultorio jurídico</p>
      </div>
